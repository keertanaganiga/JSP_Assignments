	...
	public static void main(String[] args) {
		String databaseURL="jdbc:ucanaccess://Detail.accdb";
			...
			try {
				...
				statement.executeUpdate("insert into Details values 'keertana','keertanaganiga@gmail.com','7654342356'");
				statement.executeUpdate("insert into Details values 'kartik','kartikganiga@gmail.com','9654892356'");
